...
//Googleが出している奴はAPIが８とかだと使えなかった。(ビルドエラー)
//Geminiに作ってもらった。

public class AlphaThresholdImageButton extends AppCompatImageButton {

    //この値よりアルファ値が低いピクセルはタップを無視する (0-255の範囲)
